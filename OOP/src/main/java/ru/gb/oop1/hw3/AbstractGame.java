...
public abstract class AbstractGame implements Game {
    ...
    public void start(Integer sizeWord, Integer maxTry) {
        ...
        logger.addLog("Start: " + computerWord);
    }

    @Override
    public void restart() {
        logger.addLog("Restart");
    ...
    public Answer inputValue(String value) {
        if (currentTry >= maxTry) {
            ...
            logger.addLog("вы проиграли по количеству попыток");

            return null;
        }

        logger.addLog("вы ввели: " + value);
        int bull = 0;
        int cow = 0;
